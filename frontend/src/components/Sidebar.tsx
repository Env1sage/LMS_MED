...
import {
  ...
  BarChart3, Shield, Settings, LogOut, Package
} from 'lucide-react';
    ...
    <div className="bo-sidebar">
      ...
      <div className="bo-sidebar-user">
        <div className="bo-sidebar-user-info">
          <div className="bo-sidebar-avatar">
            {user?.fullName ? user.fullName.slice(0, 2).toUpperCase() : 'BO'}
          </div>
          <div>
            <div className="bo-sidebar-user-name">{user?.fullName || 'Bitflow Owner'}</div>
            <div className="bo-sidebar-user-email">{user?.email || 'owner@bitflow.com'}</div>
          </div>
        </div>
