...
import { ArrowLeft, BarChart3, TrendingUp, Award, Target, Calendar, BookOpen, FileText } from 'lucide-react';
        ...
        <div className="bo-card" style={{ padding: 24, marginBottom: 24 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: 16 }}>
            {analytics.courseProgress.map((course, idx) => {
              ...
              const progress = isCompleted ? 100 : (course.totalSteps > 0 ? Math.round((course.completedSteps / course.totalSteps) * 100) : 0);
