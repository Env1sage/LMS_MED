...
import { Save, ArrowLeft, BookOpen, Video, FileText, Image as ImageIcon, X } from 'lucide-react';
...
const EditLearningUnit: React.FC = () => {
  ...
  const loadUnit = async () => {
    try {
      ...
      setCoverImageUrl((unit as any).coverImageUrl || (unit as any).thumbnailUrl || '');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      (dto as any).coverImageUrl = coverImageUrl || undefined;
      (dto as any).thumbnailUrl = coverImageUrl || undefined;
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="bo-card" style={{ padding: 20, marginBottom: 16 }}>
            ...
            <p style={{ fontSize: 12, color: 'var(--bo-text-muted)', marginBottom: 14 }}>
              Thumbnail shown across the platform. Auto-generated from ISBN if not set.
            </p>
            {!coverImageUrl ? (
              <FileUploadButton
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                <div style={{ width: 80, height: 110, borderRadius: 8, overflow: 'hidden', border: '2px solid var(--bo-border)', background: '#1a1a2e', flexShrink: 0 }}>
                  <img
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: 12, color: 'var(--bo-text-muted)', marginBottom: 8, wordBreak: 'break-all' }}>{coverImageUrl}</div>
