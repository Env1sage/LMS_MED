              ...
              <div key={c.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '14px 16px', background: 'var(--bo-bg)', borderRadius: 8, cursor: 'pointer', transition: 'all 0.15s' }} onClick={() => navigate(`/faculty/courses/${c.id}`)}>
                <div>
                  ...
                  <div style={{ fontSize: 12, color: 'var(--bo-text-muted)', marginTop: 2 }}>
                    {({'YEAR_1':'Year 1','YEAR_2':'Year 2','YEAR_3_PART1':'Year 3 Part 1','YEAR_3_PART2':'Year 3 Part 2','INTERNSHIP':'Internship','FIRST_YEAR':'Year 1','SECOND_YEAR':'Year 2','YEAR_3_MINOR':'Year 3 Part 1','YEAR_3_MAJOR':'Year 3 Part 2','THIRD_YEAR':'Year 3 Part 1','FOURTH_YEAR':'Year 3 Part 2','FIFTH_YEAR':'Internship','PART_1':'Year 3 Part 1','PART_2':'Year 3 Part 2','YEAR_3':'Year 3 Part 1','YEAR_4':'Year 3 Part 2','YEAR_5':'Internship'} as Record<string,string>)[c.academicYear] || c.academicYear?.replace(/_/g, ' ')} · {c.stepCount} steps · {c.assignmentCount} assigned
                  </div>
                </div>
