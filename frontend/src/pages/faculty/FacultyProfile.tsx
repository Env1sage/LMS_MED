...
import { ArrowLeft, Shield, Mail, Calendar, Key, CheckCircle, AlertCircle, Clock, Eye, EyeOff } from 'lucide-react';
              ...
              <div style={{ marginBottom: 14 }}>
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  <button type="button" onClick={() => setShowCurrentPw(v => !v)}
                    style={{ position: 'absolute', right: 12, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', color: 'var(--bo-text-muted)', padding: 0, display: 'flex' }}>
