    ...
    <FacultyLayout>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="bo-card" style={{ padding: 20, marginBottom: 20, display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: 12 }}>
          ...
          <div><div style={{ fontSize: 12, color: 'var(--bo-text-muted)' }}>Academic Year</div><div style={{ fontWeight: 600, fontSize: 14 }}>{({'YEAR_1':'Year 1','YEAR_2':'Year 2','YEAR_3':'Year 3','YEAR_3_PART1':'Year 3 (Part 1)','YEAR_3_PART2':'Year 3 (Part 2)','YEAR_4':'Year 4','YEAR_5':'Year 5','FIRST_YEAR':'1st Year','SECOND_YEAR':'2nd Year','THIRD_YEAR':'3rd Year','FOURTH_YEAR':'4th Year','FIFTH_YEAR':'5th Year','INTERNSHIP':'Internship','PART_1':'Part 1','PART_2':'Part 2'} as Record<string,string>)[course?.academicYear || ''] || course?.academicYear?.replace(/_/g, ' ')}</div></div>
