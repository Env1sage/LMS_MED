                          ...
                          <td>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                              {item.thumbnailUrl && getAuthImageUrl(item.thumbnailUrl) ? (
                                <div style={{ width: 36, height: 48, borderRadius: 4, overflow: 'hidden', flexShrink: 0, border: '1px solid var(--bo-border)', background: '#1a1a2e' }}>
                                ...
                                <BookCover title={item.title} type={item.type} width={36} height={48} />
                              )}
                        ...
                        <tr key={mcq.id}>
                          ...
                          <td>
                            <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
                              ...
                              {mcq.status !== 'ACTIVE' && (
                                <button
                                  onClick={() => handleStatusChange(mcq.id, 'ACTIVE')}
                                  className="success-btn-sm"
                                  title="Activate"
                                  style={{ padding: '4px 8px', fontSize: 12 }}
                                >
                              ...
                              {mcq.status === 'ACTIVE' && (
                                <button
                                  onClick={() => handleStatusChange(mcq.id, 'INACTIVE')}
                                  className="danger-btn-sm"
                                  title="Deactivate"
                                  style={{ padding: '4px 8px', fontSize: 12 }}
                                >
                ...
                {selectedContent && (
                  <div className="content-details">
                    <div className="detail-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                      ...
                      <div className="detail-item">
                        <label>Created</label>
                        <p>{formatDateTime(selectedContent.createdAt)}</p>
                      </div>
                    </div>
                ...
                {selectedMcq && (
                  <div className="mcq-details">
                    ...
                    <div className="detail-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginTop: '16px' }}>
                      ...
                      <div className="detail-item">
                        <label>Created</label>
                        <p>{formatDateTime(selectedMcq.createdAt)}</p>
                      </div>
                    </div>
