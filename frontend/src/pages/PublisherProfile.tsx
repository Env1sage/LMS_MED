...
import { Save, Shield, Calendar, Building2, Mail, MapPin, ArrowLeft, Phone, Globe, FileText } from 'lucide-react';
        ...
        <div className="bo-card" style={{ padding: 24, marginBottom: 16 }}>
          ...
          {!editing ? (
            <>
              ...
              {infoRow(<Phone size={16} />, 'Contact Phone', profile.contactPhone)}
              {infoRow(<Globe size={16} />, 'Website', profile.website)}
              {infoRow(<MapPin size={16} />, 'Address', profile.address)}
              {infoRow(<MapPin size={16} />, 'City', profile.city)}
              {infoRow(<MapPin size={16} />, 'State', profile.state)}
              {infoRow(<FileText size={16} />, 'Description', profile.description)}
              ...
              {infoRow(<Calendar size={16} />, 'Contract Start', profile.contractStartDate ? formatDate(profile.contractStartDate) : '—')}
              {infoRow(<Calendar size={16} />, 'Contract End', profile.contractEndDate ? formatDate(profile.contractEndDate) : '—')}
              {infoRow(<Calendar size={16} />, 'Account Created', formatDate(profile.createdAt))}
            </>
          ) : (
              ...
              <div style={{ display: 'grid', gap: 16 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                  <div>
                    ...
                    <input style={inputStyle} value={editData.contactPhone || ''}
                      onChange={e => setEditData(d => ({ ...d, contactPhone: e.target.value }))} />
                  </div>
                  <div>
                    <label style={labelStyle}>Website</label>
                    <input style={inputStyle} value={editData.website || ''}
                      onChange={e => setEditData(d => ({ ...d, website: e.target.value }))} />
                  </div>
                </div>
                <div>
                  <label style={labelStyle}>Address</label>
                  <input style={inputStyle} value={editData.address || ''}
                ...
                <div>
                  ...
                  <textarea style={{ ...inputStyle, minHeight: 60 }} value={editData.description || ''}
