...
import { ArrowLeft, Users, Star, TrendingUp, Award, RefreshCw, ChevronDown, ChevronUp, BookOpen, BarChart3, MessageSquare, X, Search } from 'lucide-react';
                          ...
                          {detailData.feedbackList.slice(0, 10).map((f, fi) => (
                            <div key={fi} style={{ padding: '10px 12px', borderRadius: 8, background: 'var(--bo-bg)', border: '1px solid var(--bo-border)' }}>
                              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                                ...
                                <span style={{ fontSize: 10, color: 'var(--bo-text-muted)' }}>{formatDate(f.createdAt)}</span>
                              </div>
