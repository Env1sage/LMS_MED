...
export class TopicsController {
  ...
  async create(@Body() dto: CreateTopicDto, @Request() req: any) {
    return this.topicsService.create(dto, req.user.userId);
  }
  ...
  async bulkImport(@Body() topics: CreateTopicDto[], @Request() req: any) {
    return this.topicsService.bulkImport(topics, req.user.userId);
  }
  ...
  async update(
    ...
    return this.topicsService.update(id, dto, req.user.userId);
  }
  ...
  async delete(@Param('id') id: string, @Request() req: any) {
    return this.topicsService.delete(id, req.user.userId);
  }
}
