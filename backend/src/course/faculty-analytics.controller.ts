...
export class FacultyAnalyticsController {
  ...
  async getDashboardOverview(@Req() req: any) {
    return this.facultyAnalyticsService.getDashboardOverview(req.user.userId);
  }
  ...
  async getAllStudents(
    ...
    return this.facultyAnalyticsService.getAllStudents(req.user.userId, filter, year);
  }
  ...
  async getCourseAnalytics(
    ...
    return this.facultyAnalyticsService.getCourseAnalytics(req.user.userId, courseId);
  }
  ...
  async getBatchSummary(
    ...
    return this.facultyAnalyticsService.getBatchSummary(req.user.userId, courseId);
  }
  ...
  async getMcqAnalytics(
    ...
    return this.facultyAnalyticsService.getMcqAnalytics(req.user.userId, courseId);
  }
  ...
  async getStudentProgress(
    ...
    return this.facultyAnalyticsService.getStudentProgress(req.user.userId, courseId, studentId);
  }
  ...
  async generateReport(
    ...
    return this.facultyAnalyticsService.generateReport(req.user.userId, courseId, format);
  }
