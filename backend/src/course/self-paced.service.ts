...
export class SelfPacedService {
  ...
  /**
   * Save a self-paced resource to the student's library
   */
  async saveToLibrary(resourceId: string, userId: string): Promise<{ success: boolean }> {
